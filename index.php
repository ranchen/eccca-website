...
<?php include("header.html");?>
  ...
  <div class="text">
    <?php
    $file = fopen('./text/welcome.txt', 'rb') or exit('Unable to open file.');
    echo trim(fread($file, filesize('./text/welcome.txt')));
    fclose($file);
    ?>
  </div>
